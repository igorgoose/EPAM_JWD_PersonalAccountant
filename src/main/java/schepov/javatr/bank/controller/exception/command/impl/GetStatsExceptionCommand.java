...
public class GetStatsExceptionCommand implements ExceptionCommand {

    private static final GetStatsExceptionCommand instance = new GetStatsExceptionCommand();

    private GetStatsExceptionCommand(){

    }

    public static GetStatsExceptionCommand getInstance(){
        return instance;
    }
    ...
    public String execute(Exception e, Logger logger) {
        ...
        return StringLiterals.RESPONSE_GET_STATS_FAIL;
    }
}
